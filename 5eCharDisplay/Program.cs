...
namespace _5eCharDisplay
{
	...
	internal static class Program
	{
		...
		static void MoveToNewSpellcasting()
		{
            ...
            newlock.prepMethod = oldlock.prepMethod;
            newlock.Cantrips = oldlock.Cantrips;
            newlock.AlwaysPrepared = oldlock.AlwaysPrepared;
            newlock.PreparedSpells = oldlock.PreparedSpells;
            newlock.FirstLevelSpells = oldlock.FirstLevelSpells;
            newlock.SecondLevelSpells = oldlock.SecondLevelSpells;
            newlock.ThirdLevelSpells = oldlock.ThirdLevelSpells;
            newlock.FourthLevelSpells = oldlock.FourthLevelSpells;
            newlock.FifthLevelSpells = oldlock.FifthLevelSpells;
            newlock.SixthLevelSpells = oldlock.SixthLevelSpells;
            newlock.SeventhLevelSpells = oldlock.SeventhLevelSpells;
            newlock.EighthLevelSpells = oldlock.EighthLevelSpells;
            newlock.NinthLevelSpells = oldlock.NinthLevelSpells;
            newlock.spellcastingAbilityModifier = Ferrous.charisma;
            newlock.spellSlots = oldlock.spellSlots;
            newlock.spellSlotsMax = oldlock.spellSlotsMax;
            newlock.spellPrepLevel = oldlock.SpellPrepLevel;
